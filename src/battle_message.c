...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_SRCPKMNREGAINEDHEALTH]                = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s HP was restored."),
    ...
    [STRINGID_PKMNEVOLVED]                          = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} evolved due to it's will to survive!"),
